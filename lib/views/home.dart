...
import 'package:recipedia/models/recipe_model.dart';
import 'package:recipedia/views/recipe_view.dart';
                        ...
                        InkWell(
                            onTap: () async {
                              if (textEditingController.text.isNotEmpty) {
                                ...
                                recipies = new List();
                                String url =
                                    "https://api.edamam.com/search?q=${textEditingController.text}&app_id=${appId}&app_key=${appKey}";
